#ifndef NMOPT_APPLICATION_RUNNER_CHAPTER6_EXECUTION_HPP
#define NMOPT_APPLICATION_RUNNER_CHAPTER6_EXECUTION_HPP
...
namespace nmopt::application::runner::chapter6_execution
{
  ...
  inline nmopt::experiment::RunEnvironmentRecord
  ...
  inline const std::array<nmopt::application::runner::BenchmarkExecutionRegistration, 2> &
  ...
  inline const nmopt::application::runner::BenchmarkExecutionRegistration *
