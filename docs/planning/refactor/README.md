# Stage B refactor routing

This directory separates operational refactor guidance from the exhaustive
assessment evidence. An agent executing one batch should not read the full
...
The integration branch is `codex/refactor-ch5-ch6-readiness`. The immutable
