...
- the [Chapter 5 implementation guide](chapter-5-implementation-guide.md);
- the [Chapter 6 numerical-methods guide](chapter-6-numerical-methods-guide.md);
- the [Chapter 6 numerical-examples reference](chapter-6-numerical-examples.md);
...
```text
docs/pre-chapter-5-6-refactor-assessment.md
```
...
4. Create `docs/pre-chapter-5-6-refactor-assessment.md`.
