...
// This solver scenario is included into the existing neutral contract test
// translation unit to improve responsibility locality without multiplying
// test targets or compilation cost.
